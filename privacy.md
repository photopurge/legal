...
PhotoPurge requests access to your **photo and video library** so it can show you items to review and so it can delete items at your request. This access is used **only on the device**:
...
PhotoPurge integrates a small number of third-party services to enable advertising, subscription payments, and store distribution. These services may collect limited information as described below.
...
PhotoPurge offers an optional Pro subscription and a one-time Lifetime purchase. Payment processing is handled exclusively by the Apple App Store or Google Play. We never see your payment details.
...
We use this data **only** to determine whether your device should be treated as Pro and to honour restore-purchase requests as required by the App Store and Play Store.

### c. App distribution — Apple and Google

When you install or update PhotoPurge, Apple and/or Google collect installation and crash telemetry as part of their normal store operation. We do not control this collection. Their respective policies apply:
...
- We do **not** collect or store your name, email address, phone number, postal address, or any account-style information. PhotoPurge has no user accounts and no sign-in.
- We do **not** upload your photos, videos, or any extracted content from them, to any server.
- We do **not** collect contact lists, calendar entries, microphone audio, or precise GPS location.
- We do **not** sell personal data to third parties.

## 4. Children's privacy

PhotoPurge is intended for users 18 and older. We do not knowingly collect or solicit data from children under 13 (or under 16 in jurisdictions where that age applies). If you believe a child has used the app and provided data, please contact us at the email above and we will assist where possible.
